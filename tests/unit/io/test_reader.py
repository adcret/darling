...
class TestMosaScan(unittest.TestCase):
    ...
    def setUp(self):
        self.debug = False
        self.path_to_data, _, _ = darling.io.assets.mosaicity_scan()

    def test_init(self):
        # Assert that the reader can be instantiated.
        reader = darling.io.reader.MosaScan(self.path_to_data)
        self.assertTrue(isinstance(reader, darling.io.reader.MosaScan))
    ...
    def test_roi_read(self):
        ...
        reader = darling.io.reader.MosaScan(
            self.path_to_data,
        )
    ...
    def test_drift(self):
        path_to_data, data, motors = darling.io.assets.motor_drift()
        self.check_data(data, motors)
...
class TestRockingScan(unittest.TestCase):
    ...
    def setUp(self):
        self.debug = False
        self.path_to_data, _, _ = darling.io.assets.rocking_scan()

    def test_init(self):
        # Assert that the reader can be instantiated.
        reader = darling.io.reader.RockingScan(self.path_to_data)
        self.assertTrue(isinstance(reader, darling.io.reader.RockingScan))
    ...
    def test_roi_read(self):
        # assert that the reader will read a roi
        reader = darling.io.reader.RockingScan(
            self.path_to_data,
        )
    ...
    def test_fetch(self):
        ...
        reader = darling.io.reader.MosaScan(path)
